...
with_node \
  ...
  --target "/Users/user281297/VeroMobileApp/ios/Pods/Target Support Files/Pods-VeroV1/ExpoModulesProvider.swift" \
  --entitlement "/Users/user281297/VeroMobileApp/ios/VeroV1/VeroV1.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-secure-store"
